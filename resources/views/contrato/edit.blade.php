...
<ol class="breadcrumb">
  ...
  <li><a class="active">Edición de contrato</a></li>
</ol>
               <div class="row" id="box-wrapper">
                ...
                <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- form start -->
                    {!! Form::model($contrato, ['route' => ['contrato.update', $contrato->id], "method" => "PUT", "enctype" => "multipart/form-data"]) !!}
                        @include('contrato.partials.form', ["SubmitBtnText"=>"Actualizar", "disabled" =>""])
                    {!! Form::close() !!}
              </div><!-- /.box -->
            </div>
          </div>
