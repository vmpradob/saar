							...
							<table class="table table-hover table-condensed">
								<thead  class="bg-primary">
									<tr>
										...
										@endforeach
										<th rowspan="2" class="text-center" align="center" style="vertical-align: middle" >SALDO FAVOR.</th>
										<th rowspan="2" class="text-center" align="center" style="vertical-align: middle" >AJUSTE.</th>
								...
								<tbody>
									...
									<tr title="{{$fecha}}" >
										...
										@foreach($montosDias as $dia => $monto)
											@if($dia == $fecha)
												<td align="right" class="text-right ">{{ $traductor->format($saldoDia[$fecha]) }}</td>
												<td align="right" class="text-right">{{ $traductor->format($ajustesDia[$fecha]) }}</td>
									...
									<tr class="bg-gray">
										<td><strong>TOTALES</strong></td>
											@foreach($montosTotales as $moduloNombre => $conceptos)
												...
												@endforeach
											@endforeach
										<td align="right" id="totalSaldo" class="text-right" style="font-weight: bold">{{ $traductor->format($saldoMes) }}</td>
										<td align="right" id="totalAjuste" class="text-right" style="font-weight: bold">{{ $traductor->format($ajustesMes) }}</td>
	...
	$(document).ready(function(){
		...
		$('#export-btn').click(function(e){
			...
			$(table).append('<tr>\
								...
								<td colspan="14" align="center" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 7px">REVISADO</td>\
								<td colspan="13" align="center" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 7px">CONFORMADO</td>\
								</tr><tr>\
								...
								<td colspan="7" align="center" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black;"> </td>\
								</tr><tr>\
								...
								<td colspan="5" align="center" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 6px">CONTADOR</td>\
								...
								<td colspan="7" align="center" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 6px">DIRECTOR</td>\
							</tr>')
