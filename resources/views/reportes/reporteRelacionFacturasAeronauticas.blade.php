...
<ol class="breadcrumb">
    ...
    <li><a class="active">Relación de Facturas Aeronáuticas Cobradas</a></li>
</ol>
<div class="row" id="box-wrapper">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                {!! Form::open(["url" => action('ReporteController@getReporteRelacionFacturasAeronauticas'), "method" => "GET", "class"=>"form-inline"]) !!}
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-default text-right" href="{{action('ReporteController@getReporteRelacionFacturasAeronauticas')}}">Reset</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
