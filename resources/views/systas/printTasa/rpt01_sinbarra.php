...
//	$pdf->RotatedImage('barcode/img/barcode_'.$i.'.png','90','47','','10','90');
	$pdf->RotatedImage('barcode/img/barcode_'.$i.'.png','86','53','','13','90');
	$pdf->RotatedImage('barcode/img/white.jpg','83.4','53','','13','90');
	//$pdf->RotatedImage('barcode/img/barcode_'.$i.'.png','76','35','35','tamaño','angulo');
	
	// ID AEROPUERTO
	$pdf->SetFont('arial','b',3.5);
	$pdf->SetY(3);	$pdf->SetX(84);
	$pdf->RotatedText(79,35,'GOBERNACION DEL ESTADO BOLIVAR',90);
	$pdf->SetY(5);	$pdf->SetX(84);
	$pdf->RotatedText(81,33,'AEROPUERTO INTERNACIONAL',90);
	$pdf->SetY(5);	$pdf->SetX(84);
	$pdf->RotatedText(83,31,'"MANUEL CARLOS PIAR"',90);
	$pdf->SetY(5);	$pdf->SetX(84);
	$pdf->RotatedText(85,15,'RIF: G-20004063-7',90);
	
	//ZONA AEROPORTURIA
	$pdf->SetFont('arial','b',14);
	$pdf->Ln(6);	$pdf->SetX(81);
	$pdf->RotatedText(88,36,'PZO',90);
	
	//PRECIO BS. TICKET DESPRENDIBLE
	$pdf->SetFont('arial','',8);
	$pdf->Ln(6);	$pdf->SetX(81);
	$pdf->RotatedText(88,22,'BS. '.$t,90);
