...
echo "$num_rows";  ?>
 ...
 $exoneradoT = mysql_num_rows($filasI);
 $exoT= $exoneradoI + $exoneradoT;
echo "$exoT";  ?>
      </td>
  </tr>
</table>
<table width="100%" border="1">
  <tr> 
    ...
    <td width="12%"> <strong> 
      <? //CONSULTA LA CANTIDAD DE TASAS NACIONALES
...
echo "$nacionales";  ?>
    ...
    <td> <strong> 
      <? //CONSULTA LA CANTIDAD DE TASAS INTERNACIONALES
...
<table width="100%" border="1">
  <tr> 
    ...
    <td width="12%"><strong> 
      <? //CONSULTA LA CANTIDAD EN BOLIVARES DE TASAS NACIONALES
 $filasN = mysql_query("SELECT * FROM concil WHERE fVer='$fver' and encargado='$u' and codtas='0001'");
 $nacionales = mysql_num_rows($filasN);
 $bn = $nacionales * 24.00 ;
echo number_format($bn, 2, ',', '.'); ?>
    ...
    <td> <strong> 
      <? //CONSULTA LA CANTIDAD EN BOLIVARES DE TASAS INTERNACIONALES
 $filasI = mysql_query("SELECT * FROM concil WHERE fVer='$fver' and encargado='$u' and codtas='0002'");
 $internacionales = mysql_num_rows($filasI);
...
<table width="100%" border="0">
  <tr> 
    ...
    <td width="23%"><div align="center"><strong> 
        ...
        //CONSULTA LA CANTIDAD TOTAL DE BOLIVARES DE TASAS
