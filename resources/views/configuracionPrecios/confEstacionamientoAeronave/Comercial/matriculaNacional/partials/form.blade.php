		...
		<div class="box box-danger estacionamientoBox">
			...
			<div class="box-body">
				...
				<div class="checkbox col-md-6"  style="margin-left: -40px">
					...
					{!! Form::select('tipo_pago_com_matricula_nac_int_id',$tipo_pagos,$estacionamientoAeronave[0]->tipo_pago_com_matricula_nac_int_id, [ 'class'=>"form-control", 'id' => 'tipo_pago_est_com_matricula_nac_int_id']) !!}
				</div><!-- /.form group -->	
				</div>								
			</div><!-- /.box-body -->
		</div><!-- /.box -->
		...
		<div class="box box-danger estacionamientoBox">
			...
			<div class="box-body">
				...
				<div class="checkbox col-md-6"  style="margin-left: -40px">
					...
					{!! Form::select('tipo_pago_com_matricula_nac_nac_id',$tipo_pagos,$estacionamientoAeronave[0]->tipo_pago_com_matricula_nac_nac_id, [ 'class'=>"form-control", 'id' => 'tipo_pago_est_com_matricula_nac_nac_id']) !!}
				</div><!-- /.form group -->	
				<!-- Definición de Bloque -->
				<div class="bootstrap-timepicker">
					<div class="form-group">
