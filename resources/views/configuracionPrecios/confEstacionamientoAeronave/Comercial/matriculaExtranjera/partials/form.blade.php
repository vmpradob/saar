		...
		<div class="box box-danger estacionamientoBox">
			...
			<div class="box-body">
				...
				<div class="bootstrap-timepicker">
					<div class="form-group">
						...
						<div class="input-group">
							{!! Form::text('tiempoLibreInt_ext', null, [ 'class'=>"form-control tiempoLibreInt","placeholder"=>"Minutos libres de cargo"]) !!}
				...
				<div class="form-group">
					<div class="input-group">
						<div class="input-group-addon">
							...
							{!! Form::text('precio_estInt_ext', null, ["id"=>"precio_estInt-input", 'class'=>"form-control precio_estInt","placeholder"=>"Precio Establecido", "readonly"=>"readonly"]) !!}
					</div><!-- /.input group -->
				</div><!-- /.form group -->
				...
				<div class="form-group">
					<div class="checkbox col-md-6"  style="margin-left: -40px">
						<label>
							{!! Form::checkbox('aplicar_minimo_int_ext', true, null) !!} <strong>Aplicar Mínimo</strong>
						</label>
					</div>
					<div class="input-group  col-md-6"> 
						...
						{!! Form::text('eq_bloqueMinimoInt_ext', null, [ 'class'=>"form-control eq_bloqueMinimoInt","placeholder"=>"Equivalente de la UT por bloque"]) !!}
					</div><!-- /.input group -->
				</div><!-- /.form group -->	
				...
				<div class="bootstrap-timepicker">
					<div class="form-group">
						...
						<div class="input-group">
							{!! Form::text('minBloqueInt_ext', null, [ 'class'=>"form-control minBloqueInt","placeholder"=>"Minutos por bloque de tiempo"]) !!}
							<div class="input-group-addon">
								min <i class="fa fa-clock-o"></i>
							</div>
						</div><!-- /.input group -->
			...
			<div class="box-body">
				...
				<div class="bootstrap-timepicker">
					<div class="form-group">
						<label><strong>Minutos Libres: </strong></label>
						<div class="input-group">
							{!! Form::text('tiempoLibreNac_ext', null, [ 'class'=>"form-control tiempoLibreNac","placeholder"=>"Minutos libres de cargo"]) !!}
							<div class="input-group-addon">
								min <i class="fa fa-clock-o"></i>
							</div>
						</div><!-- /.input group -->
				...
				<div class="form-group">
					...
					<div class="input-group"> 
						<div class="input-group-addon">
							...
							{!! Form::text('eq_bloqueNac_ext', null, [ 'class'=>"form-control eq_bloqueNac","placeholder"=>"Equivalente de la UT por bloque" ]) !!}
					</div><!-- /.input group -->
				</div><!-- /.form group -->	
				<!-- Precio -->
				<div class="form-group">
					<div class="input-group">
						<div class="input-group-addon">
							...
							{!! Form::text('precio_estNac_ext', null, ["id"=>"precio_estNac-input", 'class'=>"form-control precio_estNac","placeholder"=>"Precio Establecido", "readonly"=>"readonly"]) !!}
					</div><!-- /.input group -->
				</div><!-- /.form group -->
				<!-- Equivalente de la UT por mínimo-->
				<div class="form-group">
					<div class="checkbox col-md-6"  style="margin-left: -40px">
						<label>
							{!! Form::checkbox('aplicar_minimo_nac_ext', true, null) !!} <strong>Aplicar Mínimo</strong>
						</label>
					</div>
					<div class="input-group  col-md-6"> 
						<div class="input-group-addon">
				...
				<div class="bootstrap-timepicker">
					<div class="form-group">
						<label><strong>Cantidad de minutos por bloque a cobrar: </strong></label>
						<div class="input-group">
							{!! Form::text('minBloqueNac_ext', null, [ 'class'=>"form-control minBloqueNac","placeholder"=>"Minutos por bloque de tiempo"]) !!}
							<div class="input-group-addon">
								min <i class="fa fa-clock-o"></i>
							</div>
						</div><!-- /.input group -->
