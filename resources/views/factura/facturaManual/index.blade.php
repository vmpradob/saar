...
<ol class="breadcrumb">
	...
	<li><a class="active">Facturación Manual Dosas</a></li>
</ol>
	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body text-right"  id="container">
				{!! Form::open(["url" => action('FacturacionManualController@index',["id"=>'DOSAS']), "method" => "GET", "class"=>"form-inline"]) !!}
				...
				<a class="btn btn-default" href="{{action('FacturacionManualController@index',['DOSAS'])}}">Reset</a>
				{!! Form::close() !!}
			</div>
		</div>
	</div>
	<div class="col-md-12">
		...
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title">Facturas Manuales de Dosas</h3>
			</div><!-- /.box-header -->
			<!-- form start -->
							...
							<li class="list-group-item" data-id="1">
								<div class="media">
									...
									<div class="pull-right media-right">
										<span><a  class="btn btn-warning"  href="{{ action('FacturaController@facturaManual', 'DOSAS') }}" >Crear factura Manual</a></span>
									</div>
									<div class="media-body">
										<span class="pull-right"><a class="btn btn-primary"  href="{{action('CobranzaController@create', ['DOSAS']) }}">Generar Cobranza</a></span>
									</div>
